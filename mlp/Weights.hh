...
namespace MultiLayerPerceptron
{
	...
	class Weights
	{
		...
		public:
			 ...
			 */
			void weights(uint layer, vector<double>::iterator& first, vector<double>::iterator& last);
		...
		private:
			 ...
			 * \param last the last weight leading into this neuron.
			 */
			void itor(uint layer, vector<double>::iterator& first, 
					vector<double>::iterator& last);
