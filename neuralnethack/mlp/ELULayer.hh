...
namespace MultiLayerPerceptron
{
	class ELULayer: public Layer
	{
		public:
			...
			{ return std::make_unique<ELULayer>(*this); }
	...
	{ assert(i < theOutputs.size()); return theOutputs[i] >= 0.0 ? 1.0 : theOutputs[i] + ALPHA; }
	...
	{ assert(i < theOutputs.size()); return theOutputs[i] >= 0.0 ? 0.0 : theOutputs[i] + ALPHA; }
}
#endif
